...
#ifndef __RLORA_LORAPHYPREAMBLE_M_H
#define __RLORA_LORAPHYPREAMBLE_M_H
...
template<> inline rlora::LoRaPhyPreamble *fromAnyPtr(any_ptr ptr) { return check_and_cast<rlora::LoRaPhyPreamble*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __RLORA_LORAPHYPREAMBLE_M_H
