...
#ifndef __RLORA_LORARADIOCONTROLINFO_M_H
#define __RLORA_LORARADIOCONTROLINFO_M_H
...
inline any_ptr toAnyPtr(const rlora::LoRaConfigureRadioCommand *p) {if (auto obj = as_cObject(p)) return any_ptr(obj); else return any_ptr(p);}
template<> inline rlora::LoRaConfigureRadioCommand *fromAnyPtr(any_ptr ptr) { return ptr.get<rlora::LoRaConfigureRadioCommand>(); }
inline any_ptr toAnyPtr(const rlora::LoRaTransmissionRequest *p) {if (auto obj = as_cObject(p)) return any_ptr(obj); else return any_ptr(p);}
template<> inline rlora::LoRaTransmissionRequest *fromAnyPtr(any_ptr ptr) { return ptr.get<rlora::LoRaTransmissionRequest>(); }
inline any_ptr toAnyPtr(const rlora::LoRaReceptionIndication *p) {if (auto obj = as_cObject(p)) return any_ptr(obj); else return any_ptr(p);}
template<> inline rlora::LoRaReceptionIndication *fromAnyPtr(any_ptr ptr) { return ptr.get<rlora::LoRaReceptionIndication>(); }

}  // namespace omnetpp

#endif // ifndef __RLORA_LORARADIOCONTROLINFO_M_H
