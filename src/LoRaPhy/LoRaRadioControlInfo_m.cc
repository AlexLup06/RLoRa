...
Register_Enum(rlora::LoRaRadioCommandCode, (rlora::LoRaRadioCommandCode::LORA_RADIO_C_CONFIGURE));
...
LoRaConfigureRadioCommandDescriptor::LoRaConfigureRadioCommandDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(rlora::LoRaConfigureRadioCommand)), "")
{
...
LoRaTransmissionRequestDescriptor::LoRaTransmissionRequestDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(rlora::LoRaTransmissionRequest)), "")
{
    propertyNames = nullptr;
}
...
LoRaReceptionIndicationDescriptor::LoRaReceptionIndicationDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(rlora::LoRaReceptionIndication)), "")
{
    propertyNames = nullptr;
}
