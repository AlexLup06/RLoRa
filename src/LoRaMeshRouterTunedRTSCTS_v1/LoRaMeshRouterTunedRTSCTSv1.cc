...
#include "LoRaMeshRouterTunedRTSCTSv1.h"
...
Define_Module(LoRaMeshRouterTunedRTSCTSv1);

LoRaMeshRouterTunedRTSCTSv1::~LoRaMeshRouterTunedRTSCTSv1()
{
}
 ...
 */
void LoRaMeshRouterTunedRTSCTSv1::initialize(int stage)
{
...
void LoRaMeshRouterTunedRTSCTSv1::finish()
{
...
void LoRaMeshRouterTunedRTSCTSv1::configureNetworkInterface()
{
    // data rate
...
queueing::IPassivePacketSource* LoRaMeshRouterTunedRTSCTSv1::getProvider(cGate *gate)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handleWithFsm(cMessage *msg)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handlePacket(Packet *packet)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handleSelfMessage(cMessage *msg)
{
    EV << "handleSelfMessage" << endl;
    handleWithFsm(msg);
}

void LoRaMeshRouterTunedRTSCTSv1::handleUpperPacket(Packet *packet)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handleLowerPacket(Packet *msg)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handleCanPullPacketChanged(cGate *gate)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handlePullPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
...
void LoRaMeshRouterTunedRTSCTSv1::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void LoRaMeshRouterTunedRTSCTSv1::sendDataFrame()
{
...
void LoRaMeshRouterTunedRTSCTSv1::announceNodeId(int respond)
{
...
void LoRaMeshRouterTunedRTSCTSv1::retransmitPacket(FragmentedPacket fragmentedPacket)
{
...
void LoRaMeshRouterTunedRTSCTSv1::handleCTS(Packet *pkt)
{
    EV << "handleCTS" << endl;
...
void LoRaMeshRouterTunedRTSCTSv1::handleCTSTimeout()
{
...
bool LoRaMeshRouterTunedRTSCTSv1::withRTS()
{
    EV << "withRTS" << endl;
    auto frameToSend = getCurrentTransmission();
...
bool LoRaMeshRouterTunedRTSCTSv1::isOurCTS(cMessage *msg)
{
...
bool LoRaMeshRouterTunedRTSCTSv1::isCTSForSameRTSSource(cMessage *msg)
{
...
void LoRaMeshRouterTunedRTSCTSv1::sendRTS()
{
    EV << "sendRTS" << endl;
...
void LoRaMeshRouterTunedRTSCTSv1::sendCTS()
{
    EV << "sendCTS" << endl;
...
void LoRaMeshRouterTunedRTSCTSv1::clearRTSsource()
{
    EV << "clearRTSsource" << endl;
    rtsSource = -1;
}

void LoRaMeshRouterTunedRTSCTSv1::setRTSsource(int rtsSourceId)
{
    EV << "setRTSsource" << endl;
    rtsSource = rtsSourceId;
}

bool LoRaMeshRouterTunedRTSCTSv1::isPacketFromRTSSource(cMessage *msg)
{
...
void LoRaMeshRouterTunedRTSCTSv1::createBroadcastPacket(int payloadSize, int missionId, int source, bool retransmit)
{
...
void LoRaMeshRouterTunedRTSCTSv1::createNeighbourPacket(int payloadSize, int source, bool retransmit)
{
...
Packet* LoRaMeshRouterTunedRTSCTSv1::createHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* LoRaMeshRouterTunedRTSCTSv1::createContinuousHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* LoRaMeshRouterTunedRTSCTSv1::encapsulate(Packet *msg)
{
    EV << "encapsulate" << endl;
...
Packet* LoRaMeshRouterTunedRTSCTSv1::decapsulate(Packet *frame)
{
    EV << "decapsulate" << endl;
...
void LoRaMeshRouterTunedRTSCTSv1::invalidateBackoffPeriod()
{
    EV << "invalidateBackoffPeriod" << endl;
    backoffPeriod = -1;
}

bool LoRaMeshRouterTunedRTSCTSv1::isInvalidBackoffPeriod()
{
    EV << "isInvalidBackoffPeriod" << endl;
    return backoffPeriod == -1;
}

void LoRaMeshRouterTunedRTSCTSv1::generateBackoffPeriod()
{
...
void LoRaMeshRouterTunedRTSCTSv1::scheduleBackoffTimer()
{
...
void LoRaMeshRouterTunedRTSCTSv1::decreaseBackoffPeriod()
{
...
void LoRaMeshRouterTunedRTSCTSv1::cancelBackoffTimer()
{
...
void LoRaMeshRouterTunedRTSCTSv1::invalidateCTSCWPeriod()
{
    EV << "invalidateCTSCWPeriod" << endl;
    ctsCWPeriod = -1;
}

bool LoRaMeshRouterTunedRTSCTSv1::isInvalidCTSCWPeriod()
{
    EV << "isInvalidCTSCWPeriod" << endl;
    return ctsCWPeriod == -1;
}

void LoRaMeshRouterTunedRTSCTSv1::generateCTSCWPeriod()
{
...
void LoRaMeshRouterTunedRTSCTSv1::scheduleCTSCWTimer()
{
...
void LoRaMeshRouterTunedRTSCTSv1::cancelCTSCWTimer()
{
...
void LoRaMeshRouterTunedRTSCTSv1::turnOnTransmitter()
{
// this makes receiverPart go to idle no matter what
...
void LoRaMeshRouterTunedRTSCTSv1::turnOffReceiver()
{
...
void LoRaMeshRouterTunedRTSCTSv1::finishCurrentTransmission()
{
    EV << "finishCurrentTransmission" << endl;
    deleteCurrentTxFrame();
}

Packet* LoRaMeshRouterTunedRTSCTSv1::getCurrentTransmission()
{
...
MacAddress LoRaMeshRouterTunedRTSCTSv1::getAddress()
{
    return address;
}
...
bool LoRaMeshRouterTunedRTSCTSv1::isFreeToSend()
{
    EV << "isFreeToSend" << endl;
    return !endOngoingMsg->isScheduled() && !transmissionStartTimeout->isScheduled();
}

double LoRaMeshRouterTunedRTSCTSv1::predictOngoingMsgTime(int packetBytes)
{
