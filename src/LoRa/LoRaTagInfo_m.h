...
#ifndef __RLORA_LORATAGINFO_M_H
#define __RLORA_LORATAGINFO_M_H
...
template<> inline rlora::LoRaTag *fromAnyPtr(any_ptr ptr) { return check_and_cast<rlora::LoRaTag*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __RLORA_LORATAGINFO_M_H
