...
#ifndef __RLORA_LORAMACFRAME_M_H
#define __RLORA_LORAMACFRAME_M_H
...
template<> inline rlora::LoRaMacFrame *fromAnyPtr(any_ptr ptr) { return check_and_cast<rlora::LoRaMacFrame*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __RLORA_LORAMACFRAME_M_H
