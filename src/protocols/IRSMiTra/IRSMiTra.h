...
#ifndef IRSMITRA_IRSMITRA_H_
#define IRSMITRA_IRSMITRA_H_
...
class IRSMiTra : public MacProtocolBase, public IMacProtocol, public queueing::IActivePacketSink
{
