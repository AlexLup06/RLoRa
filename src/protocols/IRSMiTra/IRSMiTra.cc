...
#include "../IRSMiTra/IRSMiTra.h"

namespace rlora {

Define_Module(IRSMiTra);
 ...
 */
void IRSMiTra::initialize(int stage)
{
...
void IRSMiTra::configureNetworkInterface()
{
    // data rate
...
queueing::IPassivePacketSource* IRSMiTra::getProvider(cGate *gate)
{
...
void IRSMiTra::handleSelfMessage(cMessage *msg)
{
    EV << "handleSelfMessage" << endl;
    handleWithFsm(msg);
}

void IRSMiTra::handleUpperPacket(Packet *packet)
{
 ...
 */
void IRSMiTra::handleCanPullPacketChanged(cGate *gate)
{
...
void IRSMiTra::handlePullPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
...
void IRSMiTra::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void IRSMiTra::announceNodeId(int respond)
{
...
void IRSMiTra::retransmitPacket(FragmentedPacket fragmentedPacket)
{
...
void IRSMiTra::handleCTS(Packet *pkt)
{
    EV << "handleCTS" << endl;
...
void IRSMiTra::handleCTSTimeout()
{
...
bool IRSMiTra::isOurCTS(cMessage *msg)
{
...
bool IRSMiTra::isCTSForSameRTSSource(cMessage *msg)
{
...
//bool IRSMiTra::currentlyReceivingOurCTS()
//{
...
void IRSMiTra::clearRTSsource()
{
    EV << "clearRTSsource" << endl;
    rtsSource = -1;
}

void IRSMiTra::setRTSsource(int rtsSourceId)
{
    EV << "setRTSsource" << endl;
    rtsSource = rtsSourceId;
}

bool IRSMiTra::isPacketFromRTSSource(cMessage *msg)
{
...
void IRSMiTra::createBroadcastPacket(int payloadSize, int missionId, int source, bool retransmit)
{
...
Packet* IRSMiTra::createHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* IRSMiTra::createContinuousHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* IRSMiTra::encapsulate(Packet *msg)
{
    EV << "encapsulate" << endl;
...
Packet* IRSMiTra::decapsulate(Packet *frame)
{
    EV << "decapsulate" << endl;
...
void IRSMiTra::invalidateBackoffPeriod()
{
    EV << "invalidateBackoffPeriod" << endl;
    backoffPeriod = -1;
}

bool IRSMiTra::isInvalidBackoffPeriod()
{
    EV << "isInvalidBackoffPeriod" << endl;
    return backoffPeriod == -1;
}

void IRSMiTra::generateBackoffPeriod()
{
...
void IRSMiTra::scheduleBackoffTimer()
{
...
void IRSMiTra::decreaseBackoffPeriod()
{
...
void IRSMiTra::cancelBackoffTimer()
{
...
void IRSMiTra::invalidateCTSCWPeriod()
{
    EV << "invalidateCTSCWPeriod" << endl;
    ctsCWPeriod = -1;
}

bool IRSMiTra::isInvalidCTSCWPeriod()
{
    EV << "isInvalidCTSCWPeriod" << endl;
    return ctsCWPeriod == -1;
}

void IRSMiTra::generateCTSCWPeriod()
{
...
void IRSMiTra::scheduleCTSCWTimer()
{
...
void IRSMiTra::cancelCTSCWTimer()
{
...
void IRSMiTra::turnOnTransmitter()
{
// this makes receiverPart go to idle no matter what
...
void IRSMiTra::finishCurrentTransmission()
{
    EV << "finishCurrentTransmission" << endl;
    deleteCurrentTxFrame();
}

Packet* IRSMiTra::getCurrentTransmission()
{
...
MacAddress IRSMiTra::getAddress()
{
    return address;
}
