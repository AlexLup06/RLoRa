 ...
 */
void MeshRouter::initialize(int stage)
{
...
void MeshRouter::configureNetworkInterface()
{
    // data rate
 ...
 */
void MeshRouter::handleSelfMessage(cMessage *msg)
{
    handleWithFsm(msg);
}

void MeshRouter::handleUpperPacket(Packet *packet)
{
...
queueing::IPassivePacketSource* MeshRouter::getProvider(cGate *gate)
{
    return (gate->getId() == upperLayerInGateId) ? txQueue.get() : nullptr;
}

void MeshRouter::handleCanPullPacketChanged(cGate *gate)
{
...
void MeshRouter::handlePullPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
...
void MeshRouter::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
    Enter_Method_Silent();
...
Packet* MeshRouter::encapsulate(Packet *msg)
{
...
Packet* MeshRouter::decapsulate(Packet *frame)
{
 ...
 * Helper functions.
 */
void MeshRouter::finishCurrentTransmission()
{
    deleteCurrentTxFrame();
}

Packet* MeshRouter::getCurrentTransmission()
{
    ASSERT(currentTxFrame != nullptr);
    return currentTxFrame;
}

void MeshRouter::retransmitPacket(FragmentedPacket fragmentedPacket)
{
...
void MeshRouter::createBroadcastPacket(int payloadSize, int missionId, int source, bool retransmit)
{
...
void MeshRouter::announceNodeId(int respond)
{
...
void MeshRouter::turnOffReceiver()
{
    LoRaRadio *loraRadio;
    loraRadio = check_and_cast<LoRaRadio*>(radio);
...
MacAddress MeshRouter::getAddress()
{
    return address;
}
