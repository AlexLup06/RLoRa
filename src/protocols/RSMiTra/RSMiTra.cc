 ...
 */
void RSMiTra::initialize(int stage)
{
...
void RSMiTra::configureNetworkInterface()
{
    // data rate
...
queueing::IPassivePacketSource* RSMiTra::getProvider(cGate *gate)
{
...
void RSMiTra::handleSelfMessage(cMessage *msg)
{
    EV << "handleSelfMessage" << endl;
    handleWithFsm(msg);
}

void RSMiTra::handleUpperPacket(Packet *packet)
{
...
void RSMiTra::handleCanPullPacketChanged(cGate *gate)
{
...
void RSMiTra::handlePullPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
...
void RSMiTra::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void RSMiTra::announceNodeId(int respond)
{
...
void RSMiTra::retransmitPacket(FragmentedPacket fragmentedPacket)
{
...
void RSMiTra::handleCTS(Packet *pkt)
{
    EV << "handleCTS" << endl;
...
bool RSMiTra::isOurCTS(cMessage *msg)
{
...
bool RSMiTra::isCTSForSameRTSSource(cMessage *msg)
{
...
void RSMiTra::clearRTSsource()
{
    EV << "clearRTSsource" << endl;
    rtsSource = -1;
}

void RSMiTra::setRTSsource(int rtsSourceId)
{
    EV << "setRTSsource" << endl;
    rtsSource = rtsSourceId;
}

bool RSMiTra::isPacketFromRTSSource(cMessage *msg)
{
...
void RSMiTra::createBroadcastPacket(int payloadSize, int missionId, int source, bool retransmit)
{
...
Packet* RSMiTra::createHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* RSMiTra::createContinuousHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* RSMiTra::encapsulate(Packet *msg)
{
    EV << "encapsulate" << endl;
...
Packet* RSMiTra::decapsulate(Packet *frame)
{
    EV << "decapsulate" << endl;
...
void RSMiTra::invalidateBackoffPeriod()
{
    EV << "invalidateBackoffPeriod" << endl;
    backoffPeriod = -1;
}

bool RSMiTra::isInvalidBackoffPeriod()
{
    EV << "isInvalidBackoffPeriod" << endl;
    return backoffPeriod == -1;
}

void RSMiTra::generateBackoffPeriod()
{
...
void RSMiTra::scheduleBackoffTimer()
{
...
void RSMiTra::decreaseBackoffPeriod()
{
...
void RSMiTra::cancelBackoffTimer()
{
...
void RSMiTra::invalidateCTSCWPeriod()
{
    EV << "invalidateCTSCWPeriod" << endl;
    ctsCWPeriod = -1;
}

bool RSMiTra::isInvalidCTSCWPeriod()
{
    EV << "isInvalidCTSCWPeriod" << endl;
    return ctsCWPeriod == -1;
}

void RSMiTra::generateCTSCWPeriod()
{
...
void RSMiTra::scheduleCTSCWTimer()
{
...
void RSMiTra::turnOnTransmitter()
{
    // this makes receiverPart go to idle no matter what
...
void RSMiTra::finishCurrentTransmission()
{
    EV << "finishCurrentTransmission" << endl;
    deleteCurrentTxFrame();
}

Packet* RSMiTra::getCurrentTransmission()
{
