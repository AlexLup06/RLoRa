...
#ifndef RSMiTraNR_MIRS_H_
#define RSMiTraNR_MIRS_H_
...
class RSMiTraNR : public MacProtocolBase, public IMacProtocol, public queueing::IActivePacketSink
{
...
#endif /* RSMITRA_LORAMESHROUTERRTSCTSV1_H_ */
