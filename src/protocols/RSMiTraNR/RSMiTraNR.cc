 ...
 */
void RSMiTraNR::initialize(int stage)
{
...
void RSMiTraNR::configureNetworkInterface()
{
    // data rate
...
queueing::IPassivePacketSource* RSMiTraNR::getProvider(cGate *gate)
{
...
void RSMiTraNR::handleSelfMessage(cMessage *msg)
{
    EV << "handleSelfMessage" << endl;
    handleWithFsm(msg);
}

void RSMiTraNR::handleUpperPacket(Packet *packet)
{
...
void RSMiTraNR::handleLowerPacket(Packet *msg)
{
...
void RSMiTraNR::handleCanPullPacketChanged(cGate *gate)
{
...
void RSMiTraNR::handlePullPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
...
void RSMiTraNR::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void RSMiTraNR::announceNodeId(int respond)
{
...
void RSMiTraNR::retransmitPacket(FragmentedPacket fragmentedPacket)
{
...
void RSMiTraNR::handleCTS(Packet *pkt)
{
    EV << "handleCTS" << endl;
...
void RSMiTraNR::handleCTSTimeout()
{
...
bool RSMiTraNR::isOurCTS(cMessage *msg)
{
...
bool RSMiTraNR::isCTSForSameRTSSource(cMessage *msg)
{
...
void RSMiTraNR::sendCTS()
{
    ...
    scheduleAfter(ctsFS + sifs + remainderCtsCw * ctsFS + predictOngoingMsgTime(sizeOfFragment_CTSData), transmissionEndTimeout);
    sizeOfFragment_CTSData = -1;
    sourceOfRTS_CTSData = -1;
}

void RSMiTraNR::clearRTSsource()
{
    EV << "clearRTSsource" << endl;
    rtsSource = -1;
}

void RSMiTraNR::setRTSsource(int rtsSourceId)
{
    EV << "setRTSsource" << endl;
    rtsSource = rtsSourceId;
}

bool RSMiTraNR::isPacketFromRTSSource(cMessage *msg)
{
...
void RSMiTraNR::createBroadcastPacket(int payloadSize, int missionId, int source, bool retransmit)
{
...
Packet* RSMiTraNR::createHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* RSMiTraNR::createContinuousHeader(int missionId, int source, int payloadSize, bool retransmit)
{
...
Packet* RSMiTraNR::encapsulate(Packet *msg)
{
    EV << "encapsulate" << endl;
...
Packet* RSMiTraNR::decapsulate(Packet *frame)
{
    EV << "decapsulate" << endl;
...
void RSMiTraNR::invalidateBackoffPeriod()
{
    EV << "invalidateBackoffPeriod" << endl;
    backoffPeriod = -1;
}

bool RSMiTraNR::isInvalidBackoffPeriod()
{
    EV << "isInvalidBackoffPeriod" << endl;
    return backoffPeriod == -1;
}

void RSMiTraNR::generateBackoffPeriod()
{
...
void RSMiTraNR::scheduleBackoffTimer()
{
...
void RSMiTraNR::decreaseBackoffPeriod()
{
...
void RSMiTraNR::cancelBackoffTimer()
{
...
void RSMiTraNR::invalidateCTSCWPeriod()
{
    EV << "invalidateCTSCWPeriod" << endl;
    ctsCWPeriod = -1;
}

bool RSMiTraNR::isInvalidCTSCWPeriod()
{
    EV << "isInvalidCTSCWPeriod" << endl;
    return ctsCWPeriod == -1;
}

void RSMiTraNR::generateCTSCWPeriod()
{
...
void RSMiTraNR::scheduleCTSCWTimer()
{
...
void RSMiTraNR::cancelCTSCWTimer()
{
...
void RSMiTraNR::turnOnTransmitter()
{
    // this makes receiverPart go to idle no matter what
...
void RSMiTraNR::turnOffReceiver()
{
...
void RSMiTraNR::finishCurrentTransmission()
{
    EV << "finishCurrentTransmission" << endl;
    deleteCurrentTxFrame();
}

Packet* RSMiTraNR::getCurrentTransmission()
{
...
MacAddress RSMiTraNR::getAddress()
{
    return address;
}
